...
class Overview extends Component {
  ...
  render() {
    return (
      ...
      <Collapsible tabIndex={0} ransitionTime={200} trigger="Quick Overview" open={true}>
              ...
              <table className="table table-striped table-sm">
                ...
                {this.state.notingActivity.map(note =>
                  ...
                  <tr className="text-left">
                    ...
                    <td><img src={ImagePlaceholder}  className="ImagePlaceholder"/>
                {note._id}
                      </td>
...
export default connect(mapStateToProps, {fetchFormResponseStatus})(Overview);
