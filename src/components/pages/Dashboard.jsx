            ...
            <div className="row">
              <nav className="col-md-2 d-none d-md-block bg-light sidebar">
               ...
               <FeatherIcon icon="home" size="24" className="icon" />
                    ...
                    <li className="nav-item">
                      <span className="nav-link" href="#"  data-toggle="modal"
        data-target="#fsModal">
                  ...
                  <table className="table table-sm shadow-sm">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td></td>
                        <td></td>
                        		<div className="edit"><a href="#"><FeatherIcon id={pending.form._id} data-toggle="modal" data-target="#exampleModal" icon="feather" size="24" className="writeIcon"  onClick={this.getFormId}/></a> <a href="#"><FeatherIcon icon="file" size="24" className="noteIcon" /></a></div>
                      </tr>
                )}
                    </tbody>
                  </table>
...
<div className="space10"/>
 ...
 <textarea name="note" className="form-control" placeholder="Type your answer here" onChange={this.handleNoteChange.bind(this)}/>

                    </div>
                    <div className="modal-footer">

                      <button type="button" className="btn btn-success" onClick={this.getNote}>Save note</button>
                    </div>
                  </div>
                </div>
              </div>
...
<span className="float-right">
                ...
                <div className="float-right"><button type="button" className="btn bg-secondary btn-md text-light" onClick={this.rightNavButton}><FeatherIcon icon="plus" size="18" className="icon1" />
                 Add User</button>
                 </div>
                <table className="table table-striped table-sm">
                  ...
                  <tbody>
                    <tr className="text-left">
                      ...
                      <div className="edit"><a href="#"><FeatherIcon icon="trash-2" size="24" className="noteIcon" onClick={this.deleteBusinessUser}/></a></div>
)}
                    </tr>
...
<div className="space5"/>
                ...
                <div className="card-body">
                 ...
                 <input type="text" id="inputName" className="form-control" placeholder="Name" required autofocus onChange={this.handleNameChange} />
                 <input type="email" id="inputEmail" className="form-control" placeholder="Email address" required onChange={this.handleEmailChange} />
                 <input type="number" id="inputNumber" className="form-control" placeholder="Phone Number" required onChange={this.handlePhoneChange} />
                 ...
                 <button className="btn btn-lg btn-primary btn-block" type="submit " onClick={this.addUser} data-dismiss="modal"> Submit</button>
                 </div>
                </form>
            </div>
...
export default connect(mapStateToProps, {fetchFormResponseStatus})(Dashboard);
